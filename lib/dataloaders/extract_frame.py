...
def main_UCF101(v_root, f_root):
    ...
    for i, j in tqdm(enumerate(v_act_root), total=len(v_act_root)):
        ...
        Parallel(n_jobs=8)(delayed(extract_video_opencv)(p.replace('\\','/'), f_root) for p in tqdm(v_paths, total=len(v_paths)))
...
if __name__ == '__main__':
    ...
    main_UCF101(v_root=r'/home/ajaziri/Thesis_work/src/vision/main/data/UCF101_data/videos',
                f_root=r'/home/ajaziri/Thesis_work/src/vision/main/data/UCF101_data/frame')
