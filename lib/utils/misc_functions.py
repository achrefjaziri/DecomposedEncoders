...
def preprocess_image(pil_im, resize_im=True):
    ...
    if type(pil_im) != Image.Image:
        try:
            ...
            pass #we will get an exception in the case of grayscaled images
    ...
    # Add one more channel to the beginning. Tensor shape = 1,3,224,224 or 1,1,224,224
...
def accuracy_classification(output, target, topk=(1,)):
    ...
    with torch.no_grad():
        ...
        res = []
        # print('acc function',pred.shape,correct.shape)
        for k in topk:
